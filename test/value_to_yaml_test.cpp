...
void TestValueToYAML() {
	...
	try {
		...
		// Mixed type list
		std::vector<Value> mixed_list_values = {Value::INTEGER(1), Value("string"), Value::BOOLEAN(true),
		                                        Value::DOUBLE(3.14)};
		...
		std::vector<Value> nested_list_values = {Value::INTEGER(1), Value::INTEGER(2), inner_list};
